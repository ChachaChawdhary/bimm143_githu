...
In todays lab we will work with fine needle aspiration (FNA) of a breast mass from University of Wisconsin.
...
We can use our PCA result (model) to do prediction, that is take put new data into our model to predict if cancer is benine or malignant
...
Principal component analysis (PCA) is a super useful method for analyzing large datasets. It works by finding new variables (PCs) that capture the most variance from the original variables in your data set.
